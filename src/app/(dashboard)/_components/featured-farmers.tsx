...
export const FeaturedFarmers = () => {
  ...
  const farmers = [
    ...
    },
    {
      ...
      specialty: 'Heritage Turkey',
      image: '/images/3.jpeg',
      products: 15
    },
    {
      name: 'Meadow Creek Farm',
      location: 'Asheville, NC',
      specialty: 'Duck & Specialty Birds',
      image: '/images/4.jpeg',
      products: 10
    }
  ]
      ...
      <section className='mx-auto max-w-6xl px-4 py-16'>
        <div>
          ...
          <div className='mt-4 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4'>
            {farms?.map(farm => (
              <Link
                href={`/farms/${farm.name.toLocaleLowerCase().replace(/\s+/g, '-')}`}
                key={farm.id}
                className='group'
              >
